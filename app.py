...
SECTOR_KEYWORDS = {
    ...
    "Healthcare": [
        ...
        "gene therapy","ophthalm","dental","radiol","patholog","laborator",
        "imaging","specimen","molecular","dermatol","orthop","spine","cardiac",
        "respir","pulmon","renal","optic","retina","cochlear","prosthes",
        "quest diag","labcorp","medtronic","abbvie","pfizer","merck","lilly",
        "amgen","gilead","regeneron","vertex","moderna","biontech","novavax",
        "biogen","alexion","celgene","myovant","natera","guardant","insulet",
        "dexcom","intuitive","hologic","becton","baxter","zimmer","edwards life",
        "abiomed","resmed","natus","vivani","harvard bioscience","haemonetics","orasure","orasure tech",
        "invacare","natus","accuray","enovis","globus","alphatec","omeros",
        "atea","chembio","meridian bio","neogen","nuvation","relay therap",
        "protagonist","arcus","arcutis","arrowhead","athenex","athenex","atara",
        "avrobio","bellicum","blood","bone","brain","cancer","cure","disease",
        "disorder","enzyme","gene","growth","hormone","immune","infection",
        "injury","nerve","organ","pain","patient","plasma","protein","rare",
        "receptor","regen","rehab","science","stem","tissue","tumor","virus",
    ],
    "Technology": [
...
_SECTOR_PRIORITY = ["Semiconductors", "Healthcare", "Industrials", "Technology"]
...
<div class="app-header">
  ...
  <div class="header-sub"><div class="live-dot"></div>C-Level + 10% Owner &middot; SEC Form 4</div>
    ...
    # Filtro settori: includi sempre trade con settore "—" (classificazione fallita)
    # per non perdere mai dati reali per colpa del keyword matching
    if sel_sectors:
        trades = [t for t in trades
                  if t.get("sector","—") in sel_sectors or t.get("sector","—") == "—"]
    if not trades:
        st.markdown(
            '<div class="empty-state"><div class="ei">&#x1F3ED;</div>'
