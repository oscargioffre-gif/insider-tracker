...
def fetch_trades(vl, vh):
    """
    Fetch singolo da OpenInsider — 1 sola chiamata HTTP robusta.
    Tutti i ruoli attivi (officer/cob/ceo/pres/coo/cfo/gc/vp/director/10pct/other).
    Classificazione settore: keyword + SIC range check sul nome.
    Cache 2 min.
    """
