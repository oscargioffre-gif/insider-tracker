...
# ─── PASSWORD ─────────────────────────────────────────────────────────────────
ACCESS_PASSWORD = "oscar2026"   # ← cambia questa
...
def check_password():
    ...
    st.markdown("""
<style>
html,body,[class*="css"]{background:#080c10!important;color:#f0f6fc!important;font-family:Inter,sans-serif!important}
#MainMenu,footer,header{visibility:hidden}
.block-container{max-width:360px!important;margin:auto;padding-top:3rem!important}
div[data-testid="stTextInput"] input{background:#0f1419!important;border:1px solid #2d3748!important;color:#f0f6fc!important;border-radius:10px!important;font-size:1rem!important;padding:.5rem .8rem!important}
div[data-testid="stButton"] button{width:100%!important;background:linear-gradient(135deg,#10b981,#059669)!important;color:#fff!important;border:none!important;border-radius:10px!important;font-weight:700!important;font-size:.95rem!important;padding:.55rem!important}
</style>
<div style="text-align:center;padding:2rem 0 1.5rem">
  <div style="font-size:2rem;font-weight:900;color:#fff">OS <span style="color:#10b981">OpenInSider</span></div>
  <div style="font-size:.75rem;color:#4b5563;margin-top:.4rem;letter-spacing:.08em;text-transform:uppercase">Accesso privato</div>
    ...
    if st.button("Accedi"):
        if pwd == ACCESS_PASSWORD:
            ...
            st.markdown('<p style="color:#fca5a5;font-size:.85rem;text-align:center">Password errata</p>',
...
def fetch_trades(vl, vh):
    """Fetch da OpenInsider. 1 chiamata HTTP. Cache 2 min."""
    ...
    vl_val = vl * 1000
    trades = [t for t in trades if t["value"] >= vl_val]
    return trades, ""
